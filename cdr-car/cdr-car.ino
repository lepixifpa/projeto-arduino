...
int veloc4 = 170;  //Velocidade motor Bvoid setup() {
...
void seguidor() {
  if ((leituraDireito == 0) && (leituraCentro == 1) && (leituraEsquerdo == 0)) {  //Sensor central detectou a linha
    frente();                                                                     //CDR CAR move para frente
  }
  if ((leituraDireito == 1) && (leituraCentro == 0) && (leituraEsquerdo == 0)) {  //Sensor direito detectou a linha
    direita();                                                                    //CDR CAR move para a direita
  }
  if ((leituraDireito == 0) && (leituraCentro == 0) && (leituraEsquerdo == 1)) {  //Sensor esquerdo detectou a linha
